...
// Dynamo runtime 1.1.1. The shape mirrors the canonical examples in
...
func (t *Transformer) buildEPP(overrides *DynamoOverrides, servingMode airunwayv1alpha1.ServingMode) map[string]interface{} {
	...
	decodeFallback := "true"
	// DYN_ENFORCE_DISAGG is a no-op on 1.1.1 (the binding doesn't read it) but
